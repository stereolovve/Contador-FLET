...
class ContadorPerplan(ft.Column):
    ...
    def carregar_sessao_ativa(self):
        with sqlite3.connect(self.caminho_db) as conn:
            ...
            if sessao_ativa:
                ...
                self.page.snack_bar = ft.SnackBar(ft.Text("Sessão ativa recuperada."))
    ...
    def criar_sessao(self, e):
        ...
        self.salvar_sessao()
        snack_bar = ft.SnackBar(ft.Text("Sessão criada com sucesso!"))
    ...
    def end_session(self):
        ...
        for veiculo in self.contagens:
            ...
            self.save_to_db(veiculo)
        self.sessao = None
        snack_bar = ft.SnackBar(ft.Text("Sessão finalizada!"))
        self.page.overlay.append(snack_bar)
        snack_bar.open = True
